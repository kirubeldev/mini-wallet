...
export default function Settings() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Log userId with "gggggggggggggggg"
      if (user?.id) {
                    ...
                    <div className="flex items-start gap-4">
                      <div className="relative h-20 w-20 rounded-full border-2 border-gray-200 overflow-hidden bg-gray-100">
                        {formData.profileImage ? (
                          ...
                          <div className="h-full w-full flex items-center justify-center text-lg font-semibold bg-blue-100 text-blue-600">
                ...
                <div className="flex justify-center mb-4">
                  <div className="relative h-24 w-24 rounded-full border-4 border-white shadow-lg overflow-hidden">
                    {user.profileImage ? (
                      ...
                      <div className="h-full w-full flex items-center justify-center text-2xl font-bold bg-gradient-to-br from-blue-500 to-purple-600 text-white">
                        {user.firstname?.charAt(0)}
                        {user.lastname?.charAt(0)}
                      </div>
                    )}
